...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionCalibration->setObjectName("actionCalibration");
        actionRobot_Control = new QAction(MainWindow);
        actionRobot_Control->setObjectName("actionRobot_Control");
        ...
        verticalLayout->addWidget(cameraStatusLabel);

        robotStatusLabel = new QLabel(widget);
        robotStatusLabel->setObjectName("robotStatusLabel");

        verticalLayout->addWidget(robotStatusLabel);
        ...
        menubar->setGeometry(QRect(0, 0, 1412, 23));
        ...
        menuTools->addAction(actionRobot_Control);
